"""
File Name: advantagerelationshipchecking.py
Feature: Here Defines The AdvantageRelationshipChecking Class
"""

class AdvantageRelationshipChecking():
	"""This class represents a Advantage Relationship Checking Account"""

	def __init__(self, name, pin, balance):
		"""Defining the properties of this module"""
		self.monthly_maintenance_fee = 25.0
